...
const (
	SessionService_ValidateSession_FullMethodName = "/sessionpb.SessionService/ValidateSession"
	SessionService_CreateSession_FullMethodName   = "/sessionpb.SessionService/CreateSession"
)
